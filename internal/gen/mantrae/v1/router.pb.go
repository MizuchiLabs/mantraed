...
const file_mantrae_v1_router_proto_rawDesc = "" +
	...
	"\vListRouters\x12\x1e.mantrae.v1.ListRoutersRequest\x1a\x1f.mantrae.v1.ListRoutersResponse\"\x03\x90\x02\x01B\xa9\x01\n" +
	"\x0ecom.mantrae.v1B\vRouterProtoP\x01ZAgithub.com/mizuchilabs/mantraed/internal/gen/mantrae/v1;mantraev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Mantrae.V1\xca\x02\n" +
