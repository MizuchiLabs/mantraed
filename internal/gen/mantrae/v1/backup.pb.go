...
const file_mantrae_v1_backup_proto_rawDesc = "" +
	...
	"\x0eDownloadBackup\x12!.mantrae.v1.DownloadBackupRequest\x1a\".mantrae.v1.DownloadBackupResponse0\x01B\xa9\x01\n" +
	"\x0ecom.mantrae.v1B\vBackupProtoP\x01ZAgithub.com/mizuchilabs/mantraed/internal/gen/mantrae/v1;mantraev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Mantrae.V1\xca\x02\n" +
