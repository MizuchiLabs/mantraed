...
const file_mantrae_v1_agent_proto_rawDesc = "" +
	...
	"\vHealthCheck\x12\x1e.mantrae.v1.HealthCheckRequest\x1a\x1f.mantrae.v1.HealthCheckResponseB\xa8\x01\n" +
	"\x0ecom.mantrae.v1B\n" +
	"AgentProtoP\x01ZAgithub.com/mizuchilabs/mantraed/internal/gen/mantrae/v1;mantraev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Mantrae.V1\xca\x02\n" +
